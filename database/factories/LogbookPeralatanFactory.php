...
class LogbookperalatanFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'shakemap' => $this->faker->randomElement(['BAIK', 'TIDAK BAIK', 'TIDAK AKTIF']),
            'seiscomp_reg' => $this->faker->randomElement(['BAIK', 'TIDAK BAIK', 'TIDAK AKTIF']),
            'qc_seiscomp' => $this->faker->randomElement(['BAIK', 'TIDAK BAIK', 'TIDAK AKTIF']),
            'monitor_simap' => $this->faker->randomElement(['BAIK', 'TIDAK BAIK', 'TIDAK AKTIF']),
            'ws_simap' => $this->faker->randomElement(['BAIK', 'TIDAK BAIK', 'TIDAK AKTIF']),
