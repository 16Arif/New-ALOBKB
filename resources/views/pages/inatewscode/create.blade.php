...
@section('title', 'Tambah Data Kode Stasiun InaTEWS')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Tambah Data Kode Site InaTEWS</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Kode Site InaTEWS</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('inatewscode.store') }}" method="POST">
                            @csrf
