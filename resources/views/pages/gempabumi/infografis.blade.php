                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="container bg-white rounded shadow p-4 my-2">
                            ...
                            <div class="alert alert-info shadow-sm">
                                <div class="row">
                                    ...
                                    <div class="col d-flex justify-content-end">
                                        <button class="btn btn-sm btn-outline-primary" onclick="resetMap()">🔄 Refresh
                                            Peta</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- PETA DAN LEGENDA --}}
                            <div id="infografis-kegempaan" class="card mb-5 mt-2 mx-auto" style="max-width: 750px;">
                                <!-- HEADER -->
                                <div class="card-header d-flex align-items-center justify-content-center gap-3 p-3 rounded-top"
                                    ...
                                    <div class="text-start mx-4">
                                        ...
                                        <p class="text-dark mb-0">
                                            Periode
                                            {{ \Carbon\Carbon::parse($startDate)->translatedFormat('d') }}–{{ \Carbon\Carbon::parse($endDate)->translatedFormat('d F Y') }}
                                        </p>
...
@push('scripts')
    ...
    <script>
        ...
        function resetMap() {
            map.setView([0.5, 117.5], 6); // ganti sesuai nilai awal kamu
        }
