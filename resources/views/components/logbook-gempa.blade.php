...
@if ($currentTime->lessThan($cutoffTime1))
    @php
        ...
        foreach ($logbookgempas as $logbookpetir) {
    ...
    @if ($dataInRange)
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <th scope="row">Logbook Gempa</th>
                    <td>{{ $logbookgempas[0]->tanggal }}</td>
                    <td>
                        <ul>
                            <li>{{ $logbookgempas[0]->onduty1 }}</li>
                            <li>{{ $logbookgempas[0]->onduty2 }}</li>
                            <li>{{ $logbookgempas[0]->onduty3 }}</li>
                        </ul>
                    </td>
                    <td>{{ $logbookgempas[0]->kehadiran }}</td>
                    <td>{{ $logbookgempas[0]->created_at->diffForHumans() }}</td>
                </tr>
            </tbody>
        </table>
    @else
        ...
        <p class="text-center">Data Logbook Gempabumi Belum Diisi Shift Pagi</p>
    @endif
@elseif ($currentTime->lessThan($cutoffTime2))
    ...
    @else
        ...
        <p class="text-center">Data Logbook Gempabumi Belum Diisi Shift Siang</p>
    @endif
@else
    @php
    ...
    @else
        ...
        <p class="text-center">Data Logbook Gempabumi Belum Diisi Shift Malam</p>
    @endif
@endif
